...
import { Box, Button, Card, FormControl, Grid, InputAdornment, List, Pagination, TextField, Typography } from '@mui/material'
...
import { ObjectFilterProductModel, ProductModel, ProductResponseList, ProductType } from 'src/@core/type/product'
...
export default function ProductPage() {
  ...
  const [objectFilterProductModel, setObjectFilterProductModel] = useState<ObjectFilterProductModel>({
    type: ProductType[ProductType.Combo],
